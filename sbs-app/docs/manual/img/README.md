...
Drop PNGs with these names here; the manual picks them up automatically (no HTML edit).

| File | Shows |
|---|---|
| `steps-panel.png` | Steps panel: a chapter header with ★ count, starred cards, the easing dropdown and transition row |
