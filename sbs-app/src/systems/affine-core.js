 ...
 * @returns {{rx:number, ry:number, rotation:number}} rotation in degrees, rx along it (rx ≥ ry)
 */
export function ellipseOf(m, rx, ry) {
  ...
  return { rx: s1, ry: s2, rotation: theta / RAD };
}
