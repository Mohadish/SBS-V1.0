...
export const APP_VERSION  = 'V0.3.0.43';
...
export function createPrimitiveNode(overrides = {}) {
  return {
    ...
    // Parameter-link group (V0.3.0.43). Primitives sharing a primLinkId share
...
export function createColorPreset(overrides = {}) {
  return {
    ...
    ssrReflective:       false,     // V0.3.0.43: surface shows real SSR contact reflections
...
export function createCable(overrides = {}) {
  return {
    ...
    visible:      true,
    highlight:    false,
    flexible:     false,                  // V0.3.0.43: smooth spline through nodes (socketed ends
