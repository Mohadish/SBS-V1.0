...
export const APP_VERSION  = 'V0.3.0.50';
...
export function createPrimitiveNode(overrides = {}) {
  return {
    ...
    // Parameter-link group (V0.3.0.50). Primitives sharing a primLinkId share
...
export function createColorPreset(overrides = {}) {
  return {
    ...
    ssrReflective:       false,     // V0.3.0.50: surface shows real SSR contact reflections
    flatMirror:          false,     // V0.3.0.50: flat faces of this colour get true planar mirrors
...
export function createCable(overrides = {}) {
  return {
    ...
    visible:      true,
    highlight:    false,
    flexible:     false,                  // V0.3.0.50: smooth spline through nodes (socketed ends
